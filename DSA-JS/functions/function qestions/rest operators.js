...
//4. Write a function that can take any number of arguments and return their factorial. Explain how the rest operator allows you to handle an indefinite number of arguments and how you can iterate(using reduce) over them to calculate the sum.
...
//5. Write a function that can take any number of arguments and return their max. Explain how the rest operator allows you to handle an indefinite number of arguments and how you can iterate(using reduce) over them to calculate the sum.
